...
public class CherishTweenAngleZ : CherishTween
{
    public static CherishTweenAngleZ End(GameObject target)
    {
		CherishTweenAngleZ thisTween = target.GetComponent<CherishTweenAngleZ>();
        if (thisTween != null)
        {
    ...
    /// <returns></returns>
    public static CherishTweenAngleZ Begin(GameObject target, float from, float to,float time,float waitTime,bool isLocal,bool isLerp = true,ParamarCallFun _callFun = null, object paramar = null)
    {
		CherishTweenAngleZ thisTween = target.GetComponent<CherishTweenAngleZ>();
        if (thisTween == null)
        {
            thisTween = target.AddComponent<CherishTweenAngleZ>();
        }
		...
		thisTween.type = CherishTweenXYZ.Z;
        thisTween.from = from;
        thisTween.to = to;
