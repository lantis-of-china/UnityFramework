// 此文件由协议导出插件自动生成
// ID : 00001]
//****������Ϸ����C2S_CreateGameRoom_MsgType = 20021****
using System;
...
///������Ϸ����C2S_CreateGameRoom_MsgType = 20021
/// <\summary>
public class CS_CreateGameRoom : CherishBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_CreateGameRoom(){}

public CS_CreateGameRoom(UserValiadateInfor _UserValiadate, string _clubId, byte _gameType){
