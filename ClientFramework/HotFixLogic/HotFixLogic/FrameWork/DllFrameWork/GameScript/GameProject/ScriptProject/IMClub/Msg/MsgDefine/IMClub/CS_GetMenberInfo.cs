// 此文件由协议导出插件自动生成
// ID : 00001]
//****��ȡ��Ա��ϢC2S_GetMenberInfo_MsgType = 20009****
using System;
...
///��ȡ��Ա��ϢC2S_GetMenberInfo_MsgType = 20009
/// <\summary>
public class CS_GetMenberInfo : CherishBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_GetMenberInfo(){}

public CS_GetMenberInfo(UserValiadateInfor _UserValiadate, string _clubId, Int32 _menberId){
