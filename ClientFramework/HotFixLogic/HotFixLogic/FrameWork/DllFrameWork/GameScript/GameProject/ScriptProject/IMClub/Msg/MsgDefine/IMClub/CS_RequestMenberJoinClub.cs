// 此文件由协议导出插件自动生成
// ID : 00001]
//****�����������ֲ�CS_RequestMenberJoinClub_MsgType = 20039****
using System;
...
///�����������ֲ�CS_RequestMenberJoinClub_MsgType = 20039
/// <\summary>
public class CS_RequestMenberJoinClub : CherishBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_RequestMenberJoinClub(){}

public CS_RequestMenberJoinClub(UserValiadateInfor _UserValiadate, string _clubId, Int32 _menberId){
