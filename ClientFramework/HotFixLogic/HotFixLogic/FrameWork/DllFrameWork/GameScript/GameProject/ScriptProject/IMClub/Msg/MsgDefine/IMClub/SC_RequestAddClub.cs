// 此文件由协议导出插件自动生成
// ID : 00001]
//****�˳����ֲ�SC_RequestAddClub_MsgType = 20035****
using System;
...
///�˳����ֲ�SC_RequestAddClub_MsgType = 20035
/// <\summary>
public class SC_RequestAddClub : CherishBitProtocolBase {
/// <summary>
///����0ʧ�� 1�ɹ� 2�Ѿ����� 3�Ѿ�����
/// <\summary>
public byte result;
...
public SC_RequestAddClub(){}

public SC_RequestAddClub(byte _result, Int32 _menberId, string _clubId){
this.result = _result;
