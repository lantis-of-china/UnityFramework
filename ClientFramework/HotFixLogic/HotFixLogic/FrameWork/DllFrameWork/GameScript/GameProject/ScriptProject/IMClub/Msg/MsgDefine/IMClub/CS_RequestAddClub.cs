// 此文件由协议导出插件自动生成
// ID : 00001]
//****�˳����ֲ�CS_RequestAddClub_MsgType = 20034****
using System;
...
///�˳����ֲ�CS_RequestAddClub_MsgType = 20034
/// <\summary>
public class CS_RequestAddClub : CherishBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_RequestAddClub(){}

public CS_RequestAddClub(UserValiadateInfor _UserValiadate, string _clubId){
