...
///��Ա��ϸ�ṹ
/// <\summary>
public class P_ClubGradeInfo : LantisBitProtocolBase {
/// <summary>
///
/// <\summary>
...
Byte[] outBuf = null;
outBuf = ((LantisBitProtocolBase)clubGrade).Serializer();
return outBuf;
}
...
if(menberIdList==null){return "";}String resultJson = "\"menberIdList\":";resultJson += "[";List<Int32> listObj = (List<Int32>)menberIdList;
...
if(time==null){return "";}String resultJson = "\"time\":";resultJson += "\"";resultJson += time.ToString();resultJson += "\"";return resultJson;
}


public String get_clubGrade_json(){
if(clubGrade==null){return "";}String resultJson = "\"clubGrade\":";resultJson += ((LantisBitProtocolBase)clubGrade).SerializerJson();return resultJson;
}
