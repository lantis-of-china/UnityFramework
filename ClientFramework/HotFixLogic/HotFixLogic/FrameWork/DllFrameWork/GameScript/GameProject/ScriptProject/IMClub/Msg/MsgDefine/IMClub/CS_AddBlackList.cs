// 此文件由协议导出插件自动生成
// ID : 00001]
//****����Ա�������������C2S_AddBlackList_MsgType = 20020****
using System;
...
///����Ա�������������C2S_AddBlackList_MsgType = 20020
/// <\summary>
public class CS_AddBlackList : LantisBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_AddBlackList(){}

public CS_AddBlackList(UserValiadateInfor _UserValiadate, String _clubId, String _menberId){
