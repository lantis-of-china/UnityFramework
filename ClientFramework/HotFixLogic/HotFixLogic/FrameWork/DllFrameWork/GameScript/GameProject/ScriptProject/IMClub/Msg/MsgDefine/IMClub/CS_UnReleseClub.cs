// 此文件由协议导出插件自动生成
// ID : 00001]
//****��ɢ���ֲ�C2S_UnReleseClub_MsgType = 20028****
using System;
...
///��ɢ���ֲ�C2S_UnReleseClub_MsgType = 20028
/// <\summary>
public class CS_UnReleseClub : CherishBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_UnReleseClub(){}

public CS_UnReleseClub(UserValiadateInfor _UserValiadate, string _clubId){
