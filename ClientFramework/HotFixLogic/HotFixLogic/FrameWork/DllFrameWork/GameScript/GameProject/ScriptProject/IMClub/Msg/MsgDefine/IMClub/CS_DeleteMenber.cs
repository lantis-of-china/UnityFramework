// 此文件由协议导出插件自动生成
// ID : 00001]
//****��ȡ��Ա�б�C2S_DeleteMenber_MsgType = 20013****
using System;
...
///��ȡ��Ա�б�C2S_DeleteMenber_MsgType = 20013
/// <\summary>
public class CS_DeleteMenber : LantisBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_DeleteMenber(){}

public CS_DeleteMenber(UserValiadateInfor _UserValiadate, String _clubId, Int32 _menberId){
