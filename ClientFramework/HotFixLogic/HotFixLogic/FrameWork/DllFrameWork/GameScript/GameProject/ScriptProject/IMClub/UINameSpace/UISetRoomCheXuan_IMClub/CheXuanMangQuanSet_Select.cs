...
/// 创建扯旋面板
/// </summary>
public class CheXuanMangQuanSet_Select : TablePanelItem
{
	...
	public int piCount = 2;

	/// <summary>
	/// 圈芒
	/// </summary>
	private Text text_quanMang;
	public Button btn_quanMang;
	public int quanMang = 1;
	/// <summary>
	/// 休芒
	/// </summary>
	private Text text_shoushouMang;
	public Button btn_shoushouMang;
	public int xiuMang = 1;
	...
	public override void OnGetPanelInfo()
    {
        ...
        text_quanMang = GenericityTool.GetComponentByPath<Text>(tablePanel, "btn_mangQuan/txt_mangQuan");
        text_shoushouMang = GenericityTool.GetComponentByPath<Text>(tablePanel, "btn_shoushouMang/txt_shoushouMang");
        btn_quanMang = GenericityTool.GetComponentByPath<Button>(tablePanel, "btn_mangQuan");
        btn_shoushouMang = GenericityTool.GetComponentByPath<Button>(tablePanel, "btn_shoushouMang");
        btn_quanMang.onClick.AddListener(OnClickQuanMang);
        btn_shoushouMang.onClick.AddListener(OnClickShoushouMang);
	}
	...
	private void OnClickShoushouMang()
	{
		if (xiuMang == 1)
		{
			if (quanMang == 1)
	...
	public void UpShow()
    {
		...
		if (quanMang == 1)
		{
			text_quanMang.color = GetSelectColor();
			(btn_quanMang.targetGraphic as Image).overrideSprite = spriteSelect_sport.overrideSprite;
		}
		else
		{
			text_quanMang.color = GetNoSelectColor();
			(btn_quanMang.targetGraphic as Image).overrideSprite = spriteNoSelect_sport.overrideSprite;
		}

		if (xiuMang == 1)
		{			
			text_shoushouMang.color = GetSelectColor();
			(btn_shoushouMang.targetGraphic as Image).overrideSprite = spriteSelect_sport.overrideSprite;
		}
		else
		{
			text_shoushouMang.color = GetNoSelectColor();
			(btn_shoushouMang.targetGraphic as Image).overrideSprite = spriteNoSelect_sport.overrideSprite;
		}
	}
    ...
    public override void ExitCall(object parmaras)
    {
		...
		//圈芒类型
		paramarsList.Add(quanMang);
		//休芒
		paramarsList.Add(xiuMang);
