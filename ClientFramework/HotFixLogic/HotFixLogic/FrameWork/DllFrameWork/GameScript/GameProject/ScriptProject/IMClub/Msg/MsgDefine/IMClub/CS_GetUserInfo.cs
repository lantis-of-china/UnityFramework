// 此文件由协议导出插件自动生成
// ID : 00001]
//****��ȡ�û���Ϣ �Ƿ��ھ��ֲ���CS_GetUserInfo_MsgType = 20037****
using System;
...
///��ȡ�û���Ϣ �Ƿ��ھ��ֲ���CS_GetUserInfo_MsgType = 20037
/// <\summary>
public class CS_GetUserInfo : CherishBitProtocolBase {
/// <summary>
///��Ϣ��֤
/// <\summary>
...
public CS_GetUserInfo(){}

public CS_GetUserInfo(UserValiadateInfor _UserValiadate, string _clubId, Int32 _menberId){
